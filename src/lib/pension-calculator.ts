    ...
    switch (state.toUpperCase()) {
      ...
      case 'AK': // Alaska (simple graded scale example)
        if (yearsOfService <= 20) {
          ...
          const first20 = 20 * 0.02 * averageSalary;       // first 20 years @ 2%
          const over20 = (yearsOfService - 20) * 0.025 * averageSalary; // after 20 @ 2.5%
        ...
        case "AZ":
          ...
          case "KY":
            ...
            if (yearsOfService <= 10) {
              ...
              // years 21–26
              return (
                10 * 0.017 + 10 * 0.02 + (yearsOfService - 20) * 0.023
              ) * averageSalary;
            } else if (yearsOfService <= 30) {
              // years 27–30
              return (
                10 * 0.017 + 10 * 0.02 + 6 * 0.023 + (yearsOfService - 26) * 0.025
              ) * averageSalary;
            } else {
              // 30+ => 3%
              return (
